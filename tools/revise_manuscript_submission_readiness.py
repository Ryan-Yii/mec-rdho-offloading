...
def paragraph_updates() -> dict[int, str]:
    ...
    return {
        ...
        176: "The penalty heatmaps compare returned solutions under the common fixed reporting coefficient lambda_ref=1; they do not alter the reporting definition.",
